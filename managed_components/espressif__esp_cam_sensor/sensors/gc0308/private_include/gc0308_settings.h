...
/*
 * Vendor profile supplied for the K26016B03V2 / GC0308 module.
 * Source: GC0308_480_122_42.ini
 * 640x480, PID 0x9b, SCCB 0x42 (8-bit) / 0x21 (7-bit), YUV422 0xA2.
 *
 * Integration note:
 * Vendor register 0x25=0x0f is changed to 0x00 while set_format() runs.
 * The existing esp_cam_sensor S_STREAM call enables 0x25=0x0f afterward.
 * No ISP, AWB, AEC, gamma, color-matrix, or timing register is changed.
 */
#define init_reglist_DVP_8bit_640x480_vendor_K26016B03V2 \
    {0xfe, 0x00}, \
    {0x0f, 0x00}, \
    {0x01, 0x6a}, \
    {0x02, 0x70}, \
...
static const gc0308_reginfo_t DVP_8bit_20Minput_640x480_yuv422_16fps[] = {
    ...
    init_reglist_DVP_8bit_640x480_vendor_K26016B03V2,
};
